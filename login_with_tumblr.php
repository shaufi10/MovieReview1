 ...
 *
	...
	$client->redirect_uri = 'http://'.$_SERVER['HTTP_HOST'].
		dirname(strtok($_SERVER['REQUEST_URI'],'?')).'/home.php';
	$client->client_id = 'E9ztLDLdNO3FnqrbzN9SZoecaZk9lYfZUuV2IQIboHLqwnVGQh'; $application_line = __LINE__;
	$client->client_secret = '9IfY0mu3AVv0fwoceufu3QWe4531CdLSeIvVd5N36QzVTo8YAj';
