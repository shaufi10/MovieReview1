...
<div align="center">
		<table width="250px" height="80px" border="1">
			...
			<td colspan="2"> 
			<div id="header">
			<center> <h1>Movie Schedule</h1></center>
			<h2></h2>
			<h3></h3>
			</div>
			</td>
...
<div class="content" style="padding: 60px">
			...
			<td></td>
			<td><textarea name="Tanggal Rilis - Selesai" rows="2" cols="30" placeholder="Tanggal Rilis - Selesai"></textarea></td>
			</tr>
			<tr colspan=3>
			<td> <h2>Judul Film</h2> </td>
			<td></td>
